<x-app-layout>
    ...
    <section id="produk">
        <div class="px-6 py-16 mt-24 lg:mt-44 bg-jet">
            <div class="container mx-auto">
                <h2 class="text-lg font-medium text-gold uppercase tracking-widest">produk</h2>
    ...
    <section id="alasan">
        <div class="px-6 py-16 mt-16 lg:mt-44">
            ...
            <div class="container mx-auto flex flex-wrap space-y-8 mt-12">
                <div class="w-full h-96 px-8 py-14 bg-cream/60 rounded-md scale-[.96] hover:scale-100 transition duration-300 ease-in-out overflow-hidden">
                ...
                <div class="w-full h-96 px-8 py-14 bg-cream/60 rounded-md scale-[.96] hover:scale-100 transition duration-300 ease-in-out overflow-hidden">
                    ...
                    <h2 class="mt-2 text-3xl font-bold capitalize">tim berpengalaman</h2>
